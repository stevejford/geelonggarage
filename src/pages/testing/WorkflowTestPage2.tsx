...
import { WorkflowTester2 } from "@/utils/workflowTester2";
import { useToast } from "@/components/ui/use-toast";

export default function WorkflowTestPage2() {
  ...
  const runWorkflowTest = async () => {
    ...
    try {
      const tester = new WorkflowTester2(convex);
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-2xl font-bold">End-to-End Workflow Testing (Version 2)</h1>
